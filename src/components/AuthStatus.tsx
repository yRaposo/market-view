...
interface AuthStatusProps {
  isError: boolean; // Indica se houve um erro
  token: string | null; // Token de autenticação, se disponível
  code: string | null; // Código de validação, se disponível
}

// Define o componente funcional AuthStatus
export default function AuthStatus({ isError, token, code }: AuthStatusProps) {
